...
public class Scherm extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == Optimalisatie) {
            ...
            dialoog.setLocationRelativeTo(null);
            dialoog.setVisible(true);
            test = dialoog.getOptimalisatie();
            for (Server server : test) {
                System.out.println(server.getNaam());
                werkveld.lijst.add(server);
            }

            Kosten.setText("Kosten: " + dialoog.getPrijs() + " euro");
            if (dialoog.getBeschikbaarheid() * 100 == 100) {
                Beschikbaarheid.setText("Beschikbaarheid: " + dialoog.getBeschikbaarheid() * 0 + "%");
            } else {
                Beschikbaarheid.setText("Beschikbaarheid: " + dialoog.getBeschikbaarheid() * 100 + "%");
            }
