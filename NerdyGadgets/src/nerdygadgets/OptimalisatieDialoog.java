...
public class OptimalisatieDialoog extends JDialog implements ActionListener {
    ...
    private Oplossing oplossing = new Oplossing(ws1, ws2, ws3, ds1, ds2, ds3, pfsense, dbloadbalancer, getPercentage(), getAantalWebservers(), getAantalDatabaseservers());
    ...
    public int getPrijs(){
        int prijs = oplossing.berekenPrijs(besteOplossing);
        return prijs;
    }
    
    public double getBeschikbaarheid(){
        double beschikbaarheid = oplossing.berekenTotaleBeschikbaarheid(besteOplossing);
